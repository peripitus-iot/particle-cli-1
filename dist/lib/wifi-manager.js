...
module.exports = class WiFiManager {
  constructor(opts) {
    if (opts) {// TODO: something fancy with the interfaces.
      // Some users will need to be able to customize this.
    }

    this.platform = os.platform();
    this.osConnect = connect[this.platform]; // todo - allow the connector to actively check for preconditions, specific OS version support etc
