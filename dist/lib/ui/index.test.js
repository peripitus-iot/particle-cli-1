...
describe('UI', () => {
  ...
  describe('Logging device details', () => {
    it('Logs details for a single device', () => {
      ...
      expect(stdout.content).to.equal(['test-photon [000000000e00000000000001] (Photon) is offline', '  Variables:', '    name (string)', '    version (int32)', '    blinking (int32)', '  Functions:', '    int check (String args) ', '    int stop (String args) ', '    int start (String args) ', '    int toggle (String args) ', ''].join(ui.EOL));
    });
    it('Logs details for a single device excluding cloud variables', () => {
      ...
      expect(stdout.content).to.equal(['test-photon [000000000e00000000000001] (Photon) is offline', '  Functions:', '    int check (String args) ', '    int stop (String args) ', '    int start (String args) ', '    int toggle (String args) ', ''].join(ui.EOL));
    });
    it('Logs details for a single device excluding cloud functions', () => {
      ...
      expect(stdout.content).to.equal(['test-photon [000000000e00000000000001] (Photon) is offline', '  Variables:', '    name (string)', '    version (int32)', '    blinking (int32)', ''].join(ui.EOL));
    });
    it('Logs details for a single product device', () => {
      const [device] = getDetailedProductDeviceList();
      ui.logDeviceDetail(device);
      expect(stdout.content).to.equal(['prod-test-01 [e00fce0000dba0f00f000d0d] (Product 12345) is online', '  Variables:', '    name (string)', '    version (int32)', '    blinking (int32)', '  Functions:', '    int check (String args) ', '    int stop (String args) ', '    int start (String args) ', '    int toggle (String args) ', ''].join(ui.EOL));
    });
    it('Logs details for a single device summary', () => {
      const [device] = getDeviceList();
      ui.logDeviceDetail(device);
      expect(stdout.content).to.equal(['test-photon [000000000e00000000000001] (Photon) is offline', ''].join(ui.EOL));
    });
    it('Logs details for a single product device summary', () => {
      const [device] = getProductDeviceList();
      ui.logDeviceDetail(device);
      expect(stdout.content).to.equal(['prod-test-01 [e00fce0000dba0f00f000d0d] (Product 12345) is online', ''].join(ui.EOL));
    });
    it('Logs details for multiple devices', () => {
      const devices = getDetailedDeviceList();
      ui.logDeviceDetail(devices);
      expect(stdout.content).to.equal(['test-photon [000000000e00000000000001] (Photon) is offline', '  Variables:', '    name (string)', '    version (int32)', '    blinking (int32)', '  Functions:', '    int check (String args) ', '    int stop (String args) ', '    int start (String args) ', '    int toggle (String args) ', 'test-boron [e00fce0000f0c0a00c00e00a] (Boron) is online', '  Functions:', '    int start (String args) ', '    int stop (String args) ', 'test-argon [e00fce00000e0df000f0000c] (Argon) is online', '  Functions:', '    int start (String args) ', '    int stop (String args) ', ''].join(ui.EOL));
    });
    it('Logs details for multiple devices excluding cloud variables', () => {
      ...
      expect(stdout.content).to.equal(['test-photon [000000000e00000000000001] (Photon) is offline', '  Functions:', '    int check (String args) ', '    int stop (String args) ', '    int start (String args) ', '    int toggle (String args) ', 'test-boron [e00fce0000f0c0a00c00e00a] (Boron) is online', '  Functions:', '    int start (String args) ', '    int stop (String args) ', 'test-argon [e00fce00000e0df000f0000c] (Argon) is online', '  Functions:', '    int start (String args) ', '    int stop (String args) ', ''].join(ui.EOL));
    });
    it('Logs details for multiple devices excluding cloud functions', () => {
      ...
      expect(stdout.content).to.equal(['test-photon [000000000e00000000000001] (Photon) is offline', '  Variables:', '    name (string)', '    version (int32)', '    blinking (int32)', 'test-boron [e00fce0000f0c0a00c00e00a] (Boron) is online', 'test-argon [e00fce00000e0df000f0000c] (Argon) is online', ''].join(ui.EOL));
    });
    it('Logs details for multiple product devices', () => {
      const devices = getDetailedProductDeviceList();
      ui.logDeviceDetail(devices);
      expect(stdout.content).to.equal(['prod-test-01 [e00fce0000dba0f00f000d0d] (Product 12345) is online', '  Variables:', '    name (string)', '    version (int32)', '    blinking (int32)', '  Functions:', '    int check (String args) ', '    int stop (String args) ', '    int start (String args) ', '    int toggle (String args) ', 'prod-test-02 [e00fce0000000ce0de0000dd] (Product 12345) is offline', '  Variables:', '    name (string)', '    version (int32)', '    blinking (int32)', '  Functions:', '    int check (String args) ', '    int stop (String args) ', '    int start (String args) ', '    int toggle (String args) ', ''].join(ui.EOL));
    });
    it('Logs details for multiple device summaries', () => {
      const devices = getDeviceList();
      ui.logDeviceDetail(devices);
      expect(stdout.content).to.equal(['test-photon [000000000e00000000000001] (Photon) is offline', 'test-boron [e00fce0000f0c0a00c00e00a] (Boron) is online', 'test-argon [e00fce00000e0df000f0000c] (Argon) is online', ''].join(ui.EOL));
    });
    it('Logs details for multiple product device summaries', () => {
      const devices = getProductDeviceList();
      ui.logDeviceDetail(devices);
      expect(stdout.content).to.equal(['prod-test-01 [e00fce0000dba0f00f000d0d] (Product 12345) is online', 'prod-test-02 [e00fce0000000ce0de0000dd] (Product 12345) is offline', ''].join(ui.EOL));
    });
  });
  ...
  function getDetailedDeviceList() {
    return [{
      ...
      functions: ['check', 'stop', 'start', 'toggle'],
