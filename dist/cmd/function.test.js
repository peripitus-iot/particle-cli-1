...
describe('Function Command', () => {
  ...
  describe('when the function succeeds', () => {
    ...
    it('prints the return value', () => {
      ParticleAPI.prototype.callFunction.resolves({
        ok: true,
        return_value: 42
      });
      return command.callFunction({
        params: {
          device,
          function: fn,
          argument: arg
        ...
        expect(ParticleAPI.prototype.callFunction).to.have.property('callCount', 1);
        expect(ParticleAPI.prototype.callFunction.firstCall.args).to.eql([device, fn, arg, product]);
      });
    });
