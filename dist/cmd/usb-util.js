...
function openUsbDevice(usbDevice, {
  dfuMode = false
} = {}) {
  ...
  return Promise.resolve().then(() => usbDevice.open()).catch(e => handleDeviceOpenError(e));
}
/**
...
function getUsbDevices({
  ...
  return Promise.resolve().then(() => getDevices({
    includeDfu: dfuMode
  }));
}
