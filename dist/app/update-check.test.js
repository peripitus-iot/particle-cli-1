...
describe('Update Check', () => {
  ...
  let fakePkgVersion, fakeUpdateCheckTimeout, fakeUpdateCheckInterval, fakeLastVersionCheck;
  beforeEach(() => {
    fakeUpdateCheckTimeout = 1000;
    fakeUpdateCheckInterval = 0;
    fakeLastVersionCheck = 0;
    fakePkgVersion = '6.6.6';
    settings.profile_json = settings.profile_json || {
      last_version_check: undefined
    };
