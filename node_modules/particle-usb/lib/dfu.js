...
exports.Dfu = exports.DFU_STATUS_SIZE = exports.DfuBmRequestType = exports.DfuseCommand = exports.DfuDeviceStateMap = exports.DfuDeviceState = exports.DfuDeviceStatusMap = exports.DfuDeviceStatus = exports.DfuRequestType = exports.DfuError = void 0;
 ...
 * A generic DFU error.
 */
class DfuError extends _error.DeviceError {
  constructor(...args) {
    super(...args);
...
const DfuRequestType = {
  ...
  DFU_DNLOAD: 1,
  // | wBlockNum | Interface | Length  | Firmware |
  DFU_UPLOAD: 2,
...
exports.DfuRequestType = DfuRequestType;
...
exports.DfuDeviceStatus = DfuDeviceStatus;
const DfuDeviceStatusMap = (0, _keys.default)(DfuDeviceStatus).reduce((obj, key) => {
  obj[DfuDeviceStatus[key]] = key;
  return obj;
}, {}); // 6.1.2 DFU_GETSTATUS Request, USB Device Firmware Upgrade Specification, Revision 1.1

exports.DfuDeviceStatusMap = DfuDeviceStatusMap;
...
exports.DfuDeviceState = DfuDeviceState;
const DfuDeviceStateMap = (0, _keys.default)(DfuDeviceState).reduce((obj, key) => {
...
exports.DfuDeviceStateMap = DfuDeviceStateMap;
const DfuseCommand = {
...
exports.DfuseCommand = DfuseCommand;
const DfuBmRequestType = {
  HOST_TO_DEVICE: 0x21,
  DEVICE_TO_HOST: 0xA1
};
exports.DfuBmRequestType = DfuBmRequestType;
const DFU_STATUS_SIZE = 6; // FIXME:

exports.DFU_STATUS_SIZE = DFU_STATUS_SIZE;
